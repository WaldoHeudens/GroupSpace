...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupSpace.Models.Media", b =>
                {
                    b.HasOne("GroupSpace.Models.Message", null)
            ...
            modelBuilder.Entity("GroupSpace.Models.Message", b =>
                {
                    b.HasOne("GroupSpace.Areas.Identity.Data.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("GroupSpace.Models.MessageDestinations", b =>
                {
                    b.HasOne("GroupSpace.Models.Message", "Message")
                        .WithMany()
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GroupSpace.Areas.Identity.Data.ApplicationUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GroupSpace.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
